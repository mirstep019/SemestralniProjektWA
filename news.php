...
$query = "SELECT posts.post_id, posts.title, posts.category, posts.subcategory, posts.post_date, posts.content, posts.image_url, users.username, COUNT(likes.like_id) AS like_count
          FROM posts
