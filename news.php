...
$query = "SELECT posts.post_id, posts.title, posts.category, posts.subcategory, posts.post_date, posts.content, posts.image_url, posts.user_id, users.username, COUNT(likes.like_id) AS like_count
          FROM posts
...
<body>
                ...
                <?php while ($post = $result->fetch_assoc()) : ?>
                    <div class="post-preview mb-4">
                        ...
                        <p class="post-meta">
                            ...
                            <?php if (isset($_SESSION['role']) && ($_SESSION['role'] === 'admin' || $_SESSION['user_id'] == $post['user_id'])) : ?>
                                <br>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            console.log('Role in session: <?php echo json_encode($_SESSION['role']); ?>');
        });
    </script>
